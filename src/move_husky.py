...
class MoveHusky(object):
	...
	def __init__(self):
		...
		self.line_pub_obj = rospy.Publisher('/twist_marker_server/cmd_vel',Twist,queue_size=10)
	...
	def line_move_robot(self, twist_obj):
		self.line_pub_obj.publish(twist_obj)
	...
	def line_clean_class(self):
		stop_twist_obj = Twist()
		stop_twist_obj.angular.z = 0.0
		stop_twist_obj.linear.x = 0.0
		self.line_move_robot(stop_twist_obj)
		self.shutdown_detected = True
